    ...
    >
      ...
      >
        <div className="flex flex-col sm:flex-row items-start gap-5">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-500/10 text-indigo-600 shadow-sm dark:text-indigo-300 shrink-0">
            ...
            <div className="mt-5 rounded-2xl border border-amber-500/20 bg-amber-500/10 p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm leading-relaxed text-amber-700 dark:text-amber-300">
                  ...
                  and never commit real production environment variables or secret API keys to public repositories.
                </p>
              </div>
            </div>
          </div>
