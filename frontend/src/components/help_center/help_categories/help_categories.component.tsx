        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
          {categories.map((category, index) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative overflow-hidden rounded-3xl border border-slate-200 dark:border-white/10 bg-white dark:bg-white/[0.04] backdrop-blur-2xl hover:border-blue-500/40 transition-all duration-300 shadow-lg hover:shadow-2xl"
            >
              ...
              <div className="relative z-10 p-7">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500/20 to-indigo-500/20 border border-blue-500/20 flex items-center justify-center text-2xl text-blue-600 dark:text-blue-300 mb-6 group-hover:scale-110 transition-transform duration-300">
                  <i className={category.icon || "fa-solid fa-folder"}></i>
                </div>
                ...
                <div className="mt-6 flex items-center justify-between">
                  ...
                  <div className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 flex items-center justify-center text-slate-400 group-hover:text-white group-hover:bg-blue-500/80 group-hover:border-blue-500 transition-all duration-300">
